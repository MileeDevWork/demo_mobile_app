...
[![Run Tests](https://github.com/MileeDevWork/demo_mobile_app/actions/workflows/test.yml/badge.svg)](https://github.com/MileeDevWork/demo_mobile_app/actions/workflows/test.yml)
[![SonarCloud](https://github.com/MileeDevWork/demo_mobile/actions/workflows/sonarcloud.yml/badge.svg)](https://github.com/MileeDevWork/demo_mobile/actions/workflows/sonarcloud.yml)
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=MileeDevWork_demo_mobile_app&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=MileeDevWork_demo_mobile_app)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=MileeDevWork_demo_mobile_app&metric=coverage)](https://sonarcloud.io/summary/new_code?id=MileeDevWork_demo_mobile_app)
...
git branch -M main
git remote add origin https://github.com/MileeDevWork/demo_mobile.git
...
```markdown
[![Run Tests](https://github.com/MileeDevWork/demo_mobile/actions/workflows/test.yml/badge.svg)](https://github.com/MileeDevWork/demo_mobile/actions/workflows/test.yml)
```
...
```properties
sonar.projectKey=MileeDevWork_demo_mobile_app
...
**Lưu ý**: Thay thế `MileeDevWork`, `MileeDevWork_demo_mobile_app`, `YOUR_ORGANIZATION_KEY` bằng thông tin thực tế của bạn.
